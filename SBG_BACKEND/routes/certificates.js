...
router.post('/issue-certificate',(req,res,next)=>{
    let statusId="";
    let by="";
...
router.get('/issued-certificates/:userName',(req,res,next)=>{
...
router.get('/pending-approval-certificates/:userName',(req,res,next)=>{
    db.query("Select RoleId from login where UserName=?",req.params.userName,(err1,data1)=>{
        if(err1){
            console.log(err1);
            res.status(400);
...
router.get("/certificates/:userName",(req,res,next)=>{
...
router.get('/view-certificate/:id',(req, res, next) => {
    // console.log("Hey");
...
router.get("/download-certificate/:id", (req, res, next) => {
    // console.log("Hey");
...
router.post("/approve-certificate",(req,res,next)=>{
    db.query("Select StatusId from status where StatusName = ?","CertificateApproved",
    (err,data)=>{
        if(err){
            console.log(err);
...
router.post("/reject-certificate",(req,res,next)=>{
